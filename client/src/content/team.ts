...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    bio: "Основатель DMO и первый, с кем вы разговариваете. Отвечает за продажи, поиск клиентов и партнёрства — и за то, чтобы задача дошла до команды в том виде, в каком вы её описали.",
