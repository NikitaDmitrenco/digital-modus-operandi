...
export const cases: CaseStudy[] = [
  ...
  },
  {
    ...
    functions: [
      ...
      "Обработка заявок: от формы на сайте до уведомления в Telegram",
      "Две языковые версии — русская и румынская — и SEO под каждую",
      "Защита от дублей и наплыва заявок на стороне сервера",
    ],
    result:
...

  {
    ...
    proof: "Веб, Telegram и голосовой ввод — одна база задач",
  ...
  },
  {
    ...
    proof: "Цены и состав заказа проверяются на сервере",
