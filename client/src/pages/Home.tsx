...
const team = [
  {
    id: "D-01",
    name: "Арина Волкова",
    role: "Стратегия / смысл",
    bio: "Собирает хаос в точную систему решений. 9 лет в digital-продуктах.",
    skills: ["research", "strategy", "copy"],
    accent: "lime",
    portrait: "portrait-a",
  },
  {
    ...
    name: "Марк Руденко",
    role: "Дизайн / система",
    bio: "Делает интерфейсы, которыми хочется пользоваться и делиться.",
    skills: ["ux/ui", "motion", "art direction"],
    accent: "ice",
    portrait: "portrait-b",
  },
  {
    id: "D-03",
    name: "Леон Сафин",
    role: "Разработка / прототип",
    bio: "Переводит амбициозные идеи в быстрые и живучие продукты.",
    skills: ["frontend", "systems", "experiments"],
    accent: "violet",
    portrait: "portrait-c",
  },
  {
    id: "D-04",
    name: "Ида Мельник",
    role: "Партнёрство / рост",
    bio: "Держит фокус на результате, сроках и вопросах, которые не задали.",
    skills: ["growth", "ops", "analytics"],
    accent: "peach",
    portrait: "portrait-d",
  },
];
